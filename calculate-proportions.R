...
analyse <- function(grade){
  ...
  #ASH
  ASH_Y21_NSEV<-subset(ASH_Y21_NS, C4b!="I have never used an e-cigarette")
  ASH_Y21_NSEV<-subset(ASH_Y21_NSEV, C4b!="Don't want to say")
  ASH_Y21_NSEV<-subset(ASH_Y21_NSEV, !is.na(ASH_Y21_NSEV$C4b))
  ...
  #ASH
  ASH_Y21_NSNV<-subset(ASH_Y21_NS, C4b=="I have never used an e-cigarette" | is.na(ASH_Y21_NS$C4b))
  ...
  ASH_Y19_NSEV<-subset(ASH_Y19_NSEV, C4b!="Don't want to say")
  ASH_Y19_NSEV<-subset(ASH_Y19_NSEV, !is.na(ASH_Y19_NSEV$C4b))
  ...
  #In current smoker (plus recent quitters) subset...
  #STS
  ...
  #STS
  STS_A22_S<-subset(STS_A22_S, q632a1!="I have stopped smoking completely in the last year")
  print("STS Smokers 2022")
  print(nrow(STS_A22_S))
